...
- (void)setupWithType:(int)type withframe:(CGRect)frame withMessage:(NSString *)message {
    ...
    // Set up autoresizing for the transparent background (so it will expand/contract to always
    // cover the screen)
...
- (UIView *)setupAlertView {
    ...
    // Set up autoresizing for this view to keep it centered on top of the transparent parent view.
    // This keeps it centered horizontally and vertically
    [view setAutoresizingMask:(UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin |
